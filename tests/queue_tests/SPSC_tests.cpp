...
// SPSC test inst
using SPSC_Basic_Instances = ::testing::Types<TestBundle<tstl::lockfree::SPSC<int, 16>, int>,
                                              TestBundle<tstl::lockfree::SPSC<double, 16>, double>,
                                              TestBundle<tstl::lockfree::SPSC<char, 16>, char>,
                                              TestBundle<tstl::lockfree::SPSC<std::string, 16>, std::string>>;

using SPSC_Move_Instances =
        ::testing::Types<TestBundle<tstl::lockfree::SPSC<std::unique_ptr<int>, 16>, int>,
...
using SPSC_Conc_Instances = ::testing::Types<TestBundle<tstl::lockfree::SPSC<int, 1024>, int>,
                                             TestBundle<tstl::lockfree::SPSC<double, 1024>, double>,
